...
export function RatingFeedback({
  ...
  return (
    <div className="flex flex-col gap-5 justify-center items-center">
      <RatingThankYou />
      <span className="text-rating-orange  text-[14px] sm:text-[15px] text-center p-1 bg-dark-blue rounded-3xl">
        You selected {selectedRating} out of 5
      </span>
      <h2 className="text-[24px] sm:text-[28px] font-bold text-white text-center">
        Thank You!
      </h2>
